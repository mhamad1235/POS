...
<body>
    ...
    <form method="Post" action="{{route('upcash')}}"   >
        @csrf
       ...
       <tr style="width:100%;"> <td><label for="exampleInputEmail1" class="form-label">PhoneNumber</label></td>
         ...
         <td><input value={{$casher->password}} name="password" style="width:100%;" style="width: 38%;position:relative;left:1%;" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"></td>
